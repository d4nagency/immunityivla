...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Mobile IV therapy in Los Angeles. Same-day appointments and licensed clinicians—delivered to your door.",
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-3GFZ6FPM2N"></script>
        <script
